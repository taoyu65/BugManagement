...
{
    public partial class Init_11_23 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 11, 23, 14, 31, 8, 531, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Issues_ProjectVersions_ProjectVersionId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectLeaderId = table.Column<int>(nullable: false),
                    Url = table.Column<string>(nullable: true, defaultValue: "#")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2017, 11, 23, 14, 31, 8, 541, DateTimeKind.Local)),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_ProjectVersionId",
                table: "Issues",
